...
final class ActionRecorder {
    ...
    void play(Graphics2D g2) {
        for (Action act : actions) {
            //  FIXME: 💩   >
            // O AndroidLaTeXMath originalmente era um módulo Android separado. Por isso ele
            // possuía automaticamente um:
            //  io.nano.tex.BuildConfig
            // Como incorporamos os fontes Java diretamente dentro do nosso app, esse
            // BuildConfig específico não existe mais.
